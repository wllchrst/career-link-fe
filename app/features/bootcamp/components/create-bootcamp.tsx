...
import { createBootcamp, createBootcampInputSchema, type CreateBootcampInput } from "../api/create-bootcamp";
...
export const CreateBootcamp = ({onSuccess, categories, types, speakers}: Props) => {
